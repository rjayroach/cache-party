      ...
      describe "#url_for", job: true do
        it 'returns the picture of a Facebook Page' do
          ...
          VCR.use_cassette("facebook/joltcafe") do
            expect(subject.url_for :picture).to eq 'http://profile.ak.fbcdn.net/hprofile-ak-ash3/41578_138956892809631_7376_q.jpg'
          end
        end
        ...
        it 'returns the picture of a Facebook User' do
          ...
          VCR.use_cassette("facebook/davetone_basic") do
            expect(subject.url_for :picture, {type: :small}).to eq(
              'http://profile.ak.fbcdn.net/hprofile-ak-prn1/t5/174153_100005787840155_2101067759_t.jpg'
            )
          end
        end

        it "returns the url to picture small", job: true do
          subject = build(:cache_party_facebook_user)
          VCR.use_cassette("facebook/davetone_basic") do
            expect(subject.url_for(:picture)).to eq(
              "http://profile.ak.fbcdn.net/hprofile-ak-prn1/174153_100005787840155_2101067759_q.jpg")
          end
        end
        ...
        it "returns the url to picture 160x160", job: true do
          subject = build(:cache_party_facebook_user)
          VCR.use_cassette("facebook/davetone_basic") do
            expect(subject.url_for(:picture, {width: '160', height: '160'})).to eq(
              "http://profile.ak.fbcdn.net/hprofile-ak-prn1/t1/c170.50.621.621/s160x160/944425_115706918632236_180693481_n.jpg"
            )
          end
        end
      end
